...
export const inquiries: Inquiry[] = [
  ...
  { id: "INQ003", parentName: "Pooja Sharma", phone: "+91 94180 12347", childName: "Aryan", childAge: 5, classApplied: "KG", date: "2026-03-18", status: "visited", notes: "Visited campus, very interested. Following up on docs.", source: "walkin" },
  ...
  { id: "INQ008", parentName: "Neha Verma", phone: "+91 94180 12352", childName: "Anvi", childAge: 5, classApplied: "KG", date: "2026-03-21", status: "contacted", notes: "Sent brochure on WhatsApp", source: "website" },
];
...
export const seatData = [
  ...
  { className: "Class 2", totalSeats: 30, filledSeats: 27 },
  { className: "Class 3", totalSeats: 30, filledSeats: 25 },
  { className: "Class 4", totalSeats: 30, filledSeats: 23 },
  { className: "Class 5", totalSeats: 35, filledSeats: 28 },
  { className: "Class 6", totalSeats: 35, filledSeats: 26 },
  { className: "Class 7", totalSeats: 35, filledSeats: 30 },
  { className: "Class 8", totalSeats: 35, filledSeats: 22 },
];
