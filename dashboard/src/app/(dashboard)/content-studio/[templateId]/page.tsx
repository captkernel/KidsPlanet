...
export default function CustomizePage({
  ...
  // Blank canvas support: read size from URL params
  ...
  // Unified undo/redo history (fields + elements)
  ...
  return (
    <>
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        {/* Form fields - sticky left sidebar (only for template mode) */}
        {!isBlank && template && (
          ...
          <div className="card overflow-auto">
            ...
            >
              ...
              >
                ...
                >
                  {/* Template layer (skip for blank canvas) */}
      ...
      {/* Floating toolbar - rendered at page level with fixed positioning */}
